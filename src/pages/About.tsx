            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="animate-on-scroll">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 transition-colors duration-300">
                  At Genesisoft, we're committed to delivering innovative
                  digital solutions that empower businesses and individuals
                  across Zimbabwe and beyond. Our mission is to bridge the
                  digital divide and create opportunities for growth through
                  technology.
                </p>
                <p className="text-lg text-gray-600 dark:text-gray-300 transition-colors duration-300">
                  ...
                  team is dedicated to excellence, continuous learning, and
